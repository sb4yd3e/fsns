...
public function logout(){
    ...
    public function product_category_list() {
        ...
        $this->template->write('title', 'Products Category Management');
        $this->load->model('taxonomy_model', 'taxonomy');
        $this->render_data['product_category'] = $this->taxonomy->get_taxonomy_term('product_category');

        $this->template->write_view('content', 'admin/product_category_list', $this->render_data);
        $this->template->render();
    }
    ...
    public function product_category_add() {
        ...
        $this->load->model('taxonomy_model', 'taxonomy');
        $this->taxonomy->add_taxonomy_term('product_category', $data_save);

        redirect('admin/product_category_list');
    }
    ...
    public function product_category_edit() {
        ...
        if ($term_id > 0) {
            ...
            $this->load->model('taxonomy_model', 'taxonomy');
            $this->taxonomy->edit_taxonomy_term('product_category', $data_save, $term_id);
        }
        redirect('admin/product_category_list');
    }
    ...
    public function product_category_delete() {
        ...
        if ($term_id > 0) {
            $this->load->model('taxonomy_model', 'taxonomy');
            $this->taxonomy->delete_taxonomy_term('product_category', $term_id);
        }
    }
