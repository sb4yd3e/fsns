          	...
          	<div class="box-body">
            	...
            	<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						'F'=>'ปิดการแสดงผล',
								...
								{
									$selected = ($value == $this->input->post('visible')) ? ' selected="selected"' : "";
				...
				<div class="row clearfix">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<input type="text" name="delay" value="<?php echo $this->input->post('delay'); ?>" class="form-control" id="delay" />
						</div>
					</div>
				</div>
			</div>
