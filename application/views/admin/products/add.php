                ...
                <div class="box-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="thumbnail clearfix ">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sp_price[]" class="form-control digi" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <button type="button" class="btn btn-success pull-right" id="add-at" style="display: none;"><i class="fa fa-plus"></i> Add more </button>
                        </div>
