<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('product_sub_category/add'); ?>
          	<div class="box-body">
            	...
            	<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<select name="cid" class="form-control">
								...
								{
									$selected = ($product_category['cid'] == $this->input->post('cid')) ? ' selected="selected"' : "";
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<input type="text" name="sub_title" value="<?php echo $this->input->post('sub_title'); ?>" class="form-control" id="sub_title" />
						</div>
					</div>
				</div>
				<div class="row clearfix">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<textarea name="sub_description" class="form-control" id="sub_description"><?php echo $this->input->post('sub_description'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
