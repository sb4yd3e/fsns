          	...
          	<div class="box-body">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<select name="staf_id" class="form-control">
								...
								{
									$selected = ($admin['aid'] == $this->input->post('staf_id')) ? ' selected="selected"' : "";
				...
				<div class="row clearfix">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<input type="text" name="shiping_name" value="<?php echo $this->input->post('shiping_name'); ?>" class="form-control" id="shiping_name" />
						</div>
					</div>
				</div>
				<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<input type="text" name="shiping_province" value="<?php echo $this->input->post('shiping_province'); ?>" class="form-control" id="shiping_province" />
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<label for="shiping_zip" class="control-label">Shiping Zip</label>
						<div class="form-group">
							<input type="text" name="shiping_zip" value="<?php echo $this->input->post('shiping_zip'); ?>" class="form-control" id="shiping_zip" />
						</div>
					</div>
				</div>
				<div class="row clearfix">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="form-group">
							<textarea name="shiping_address" class="form-control" id="shiping_address"><?php echo $this->input->post('shiping_address'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
