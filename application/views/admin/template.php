                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo site_url('assets/admin/img/user2-160x160.png');?>" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo $user_name; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<?php echo site_url('assets/admin/img/user2-160x160.png');?>" class="img-circle" alt="User Image">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo base_url('admin/admin/edit/'.$user_id); ?>" class="btn btn-default btn-flat">Profile</a>
                                        </div>
