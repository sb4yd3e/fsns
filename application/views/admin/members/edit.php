					...
					<div class="col-lg-8">
						...
						<div class="tab-content" style="margin-top: 20px;">
							...
							<div role="tabpanel" class="tab-pane fade" id="business">
                                ...
                                <div class="form-group">
                                    <?php echo form_dropdown('business_province',list_province(),($this->input->post('business_province') ? $this->input->post('business_province') : $content['business_province']),'class="form-control" autocomplete="off"'); ?>
                                </div>
                                <label for="business_note" class="control-label">Business Note</label>
                                <div class="form-group">
                                    <textarea name="business_note" class="form-control" id="business_note" autocomplete="off"><?php echo ($this->input->post('business_note') ? $this->input->post('business_note') : $content['business_note']); ?></textarea>
                                </div>
							</div>
