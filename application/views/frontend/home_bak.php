...
<section id="content-wrapper">
    <div class="container_12">
        ...
        <article class="grid_12">
            ...
            <a href="./catalog/25/Hillbrush/31/Accessories">
                <section class="service-box"  style="text-align:center">
                    <img src="fsns_assets/misc/icons/icon4.png">

                    <h5>Accessories</h5>

                    <p>
                        Totally color coded hanger system, Cassette refill for squeegee, Automatic shoe cover dispenser, Kentucky mop bucker & Wringer on wheels.</br></br></br></br></br></br></br>
                    </p>
                </section>
            </a>
