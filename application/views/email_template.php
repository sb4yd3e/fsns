            ...
            <div role="section">
                <div class="layout one-col fixed-width"
                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column"
                             style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">

                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                                <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 22px;line-height: 31px;font-family: Avenir,sans-serif;">
                                    [header]
                                </h1>
                ...
                <div style="width: 100%; max-width: 600px; color: #ccc; font-size: 14px; margin: 20px auto; text-align: center;">
                    Food Service and Solution Co.,Ltd 29 S.Chalaemnimit, Bangkhlo, Bangkorlaem,
                    Bangkok 10120
                </div>
